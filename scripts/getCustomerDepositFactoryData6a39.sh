...
var contractAddress="0x6a39e6a987cf55a5d4eba52f94072950f27b22c8";
...
function printContractDynamicDetails() {
  ...
  var depositContractCreatedEvent = contract.DepositContractCreated({}, { fromBlock: 3567090, toBlock: "latest" });
  i = 0;
  ...
  var depositReceivedEvent = contract.DepositReceived({}, { fromBlock: 3567090, toBlock: "latest" });
  i = 0;
...
function printAddresses() {
  ...
  var numberOfDepositContracts = contract.numberOfDepositContracts();
  console.log("RESULT: contract.numberOfDepositContracts=" + numberOfDepositContracts);
  console.log("RESULT: printing from 2850");
  console.log("RESULT: (");
  for (i = 2850; i < numberOfDepositContracts; i++) {
